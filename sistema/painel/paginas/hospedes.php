...
<a onclick="inserir()" type="button" class="btn btn-primary"><span class="fa fa-plus"></span> Hóspedes</a>
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4">							
								...
								<input type="text" class="form-control" id="documento" name="cpf" placeholder="Documento Hóspede" >						
						</div>


						<div class="col-md-4">							
								<label>Data Nascimento</label>
								<input type="text" class="form-control" id="data_nascimento" name="data_nasc" placeholder="Data de Nascimento" >						
						</div>
					...
					<div class="row">
						...
						<div class="col-md-6">							
								<label>Placa Automóvel</label>
								<input type="text" class="form-control" id="placa" name="placa" placeholder="Placa Caso exista" >							
						</div>
						

						<div class="col-md-6">							
								<label>Responsável Reserva</label>
...
<div class="modal fade" id="modalDados" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row" style="margin-top: 0px">
					...
					<div class="col-md-6" style="margin-bottom: 5px">
						<span><b>Nascimento: </b></span><span id="nasc_dados"></span>
					</div>
					...
					<div class="col-md-6" style="margin-bottom: 5px">
						<span><b>Responsável: </b></span><span id="responsavel_dados"></span>
					</div>
	...
	<div class="modal fade" id="modalReservas" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="tituloModal">Reservas - <span id="nome-reservas"> </span></h4>
