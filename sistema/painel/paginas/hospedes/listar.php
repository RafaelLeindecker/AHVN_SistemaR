...
<td>
	<big><a href="#" onclick="editar('{$id}','{$nome}','{$email}','{$telefone}','{$endereco}','{$cpf}','{$obs}','{$placa}','{$responsavel}','{$data_nascF}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>
...
<big><a href="#" onclick="mostrar('{$nome}','{$email}','{$telefone}','{$endereco}','{$cpf}','{$dataF}','{$obs}','{$placa}','{$responsavel}','{$data_nascF}')" title="Mostrar Dados"><i class="fa fa-info-circle text-primary"></i></a></big>
...
<script type="text/javascript">
	function editar(id, nome, email, telefone, endereco, cpf, obs, placa, responsavel, nasc){
		$('#mensagem').text('');
	...
	function mostrar(nome, email, telefone, endereco, cpf, data, obs, placa, responsavel, nasc){
