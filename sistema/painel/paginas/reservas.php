							...
							<select class="form-control sel2" name="hospede" id="hospede" style="width:100%" required>
								...
								if($linhas > 0){
									for($i=0; $i<$linhas; $i++){
										...
										<option value="<?php echo $res[$i]['id'] ?>"><?php echo $nomeF ?> - CPF <?php echo $res[$i]['cpf'] ?></option>
									...
									<div class="col-md-6">
										...
										<form id="form_hospedes" style="margin-left: -15px">
											...
											<div class="col-md-7">							
												...
												<input type="text" class="form-control" id="cpf_checkin" name="cpf_checkin" placeholder="CPF, RG ou qualquer outro Documento" required>							
											</div>
