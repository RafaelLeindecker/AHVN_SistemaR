...
<div class="margin_mobile">
    <a onclick="inserir()" type="button" class="btn btn-primary"><span class="fa fa-plus"></span> Parlamentar</a>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control" name="cargos_publico" id="cargos_publico">
                                <?php 
								  	$query = $pdo->query("SELECT * from cargos_publico order by nome asc");
                                ...
                                <?php } }else{ ?>
                                <option value="">Cadastre um Cargo Público</option>
                                <?php } ?>
                            </select>
                        </div>
            ...
            <div class="modal-body">
                <div class="row" style="margin-top: 0px">
                    ...
                    <div class="col-md-8" style="margin-bottom: 5px">
                        <span><b>Cargo Público: </b></span><span id="cargos_publico_dados"></span>
                    </div>
                    ...
                    <div class="col-md-12" style="margin-bottom: 5px">
                        <span><b>Observação: </b></span><span id="obs_dados"></span>
                    </div>
...
<!-- Modal -->
<div class="modal fade" id="modalPermissoes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button id="btn-fechar-permissoes" type="button" class="close" data-dismiss="modal" aria-label="Close"
