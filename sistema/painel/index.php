			...
			<aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php"><span class="fa "></span>RL System<span class="dashboard_text"><?php echo $nome_sistema ?></span></a></h1>
					</div>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview <?php echo $menu_cadastros ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo $unidades ?>"><a href="index.php?pagina=unidades"><i class="fa fa-angle-right"></i> Unidades</a></li>

									<li class="<?php echo $funcionarios ?>"><a href="index.php?pagina=funcionarios"><i class="fa fa-angle-right"></i> Funcionários</a></li>

									<li class="<?php echo $parlamentares ?>"><a href="index.php?pagina=parlamentares"><i class="fa fa-angle-right"></i> Parlamentares</a></li>

									<li class="<?php echo $fornecedores ?>"><a href="index.php?pagina=fornecedores"><i class="fa fa-angle-right"></i> Fornecedores</a></li>
																		
									<li class="<?php echo $categorias_quartos ?>"><a href="index.php?pagina=categorias_quartos"><i class="fa fa-angle-right"></i> Tipo de Quarto</a></li>

									<li class="<?php echo $quartos ?>"><a href="index.php?pagina=quartos"><i class="fa fa-angle-right"></i> Quartos</a></li>

									<li class="<?php echo $cargos ?>"><a href="index.php?pagina=cargos"><i class="fa fa-angle-right"></i> Cargos</a></li>

									<li class="<?php echo $cargos_publico ?>"><a href="index.php?pagina=cargos_publico"><i class="fa fa-angle-right"></i> Cargos Público</a></li>

									<li class="<?php echo $formas_pgto ?>"><a href="index.php?pagina=formas_pgto"><i class="fa fa-angle-right"></i> Formas Pgto</a></li>

									<li class="<?php echo $turno ?>"><a href="index.php?pagina=turnos"><i class="fa fa-angle-right"></i> Turnos</a></li>
									
									<li class="<?php echo $grupos ?>"><a href="index.php?pagina=grupos"><i class="fa fa-angle-right"></i> Grupos de Acesso</a></li>
									...
									<li class="<?php echo $tiposRecursos ?>"><a href="index.php?pagina=tiposRecursos"><i class="fa fa-angle-right"></i> Tipos de Recursos</a></li>
									
									<li class="<?php echo $tipos_jornada ?>"><a href="index.php?pagina=tipos_jornada"><i class="fa fa-angle-right"></i> Tipos de Jornada</a></li>
								
									<li class="<?php echo $setor ?>"><a href="index.php?pagina=setor"><i class="fa fa-angle-right"></i> Setor</a></li>
								</ul>
							</li>
							...
							<li class="treeview <?php echo $menu_financeiro ?>">
								<a href="#">
									<i class="fa fa-usd"></i>
									<span>Entradas de Recursos</span>
									<i class="fa fa-angle-left pull-right"></i>
								</a>
								<ul class="treeview-menu">

								<li class="<?php echo $receber ?>"><a href="receber"><i class="fa fa-angle-right"></i>Planos de Trabalho</a></li>
							...
							<li class="treeview <?php echo $menu_rouparia ?>">
								<a href="#">
									<i class="fa fa-fire"></i>
									<span>Controle de Rouparia</span>
									<i class="fa fa-angle-left pull-right"></i>
								</a>
								<ul class="treeview-menu">
									
								<li class="<?php echo $jornada ?>"><a href="index.php?pagina=jornada"><i class="fa fa-angle-right"></i> Jornada</a></li>
								
								<li class="<?php echo $rel_financeiro ?>"><a href="" data-toggle="modal" data-target="#modalRelRouparia"><i class="fa fa-angle-right"></i>Relatórios</a></li>

								<li class="<?php echo $rel_lucro ?>"><a href="" data-toggle="modal" data-target="#modalRelLucro"><i class="fa fa-angle-right"></i>Demonstrativos</a></li>
							...
							<li class="treeview <?php echo $menu_relatorio ?>" >
								...
								<li class="<?php echo $rel_rouparia ?>"><a href="#" data-toggle="modal" data-target="#RelRouparia"><i class="fa fa-angle-right"></i>Relatórios Rouparia</a></li>
...
<!-- Modal Relatorio Rouparia -->
<div class="modal fade" id="RelRouparia" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">Relatório de Rouparia
                    <small>(
                        <a href="#" onclick="datas('1980-01-01', 'tudo-Ven', 'Ven')">
                            <span style="color:#000" id="tudo-Ven">Tudo</span>
                        </a> / 
                        <a href="#" onclick="datas('<?php echo date('Y-m-d'); ?>', 'hoje-Ven', 'Ven')">
                            <span id="hoje-Ven">Hoje</span>
                        </a> /
                        <a href="#" onclick="datas('<?php echo date('Y-m-01'); ?>', 'mes-Ven', 'Ven')">
                            <span style="color:#000" id="mes-Ven">Mês</span>
                        </a> /
                        <a href="#" onclick="datas('<?php echo date('Y') . "-01-01"; ?>', 'ano-Ven', 'Ven')">
            ...
            <form method="POST" action="rel/jornada_class.php" target="_blank" novalidate>
                <div class="modal-body">
                    <div class="row">
                        <!-- Data Inicial -->
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="dataInicialRel-Ven">Data Inicial</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="dataFinalRel-Ven">Data Final</label>
                        ...
                        <!-- Filtro por Status -->
                        <div class="col-md-4">
                            <label for="status_situacao">Filtro Situação</label>
                            <select class="form-control" name="status_situacao" id="status_situacao">
                    ...
                    <div class="row">
                        <!-- Jornada -->
                        <div class="col-md-4">
                            <label for="status_jornada">Jornada</label>
                            <select class="form-control" id="status_jornada" name="status_jornada">
                                <option value="Todos">Todos</option>
                                <?php 
                                    if (isset($pdo)) {
...
document.querySelector("form").addEventListener("submit", function(event) {
    const dataInicial = new Date(document.querySelector("input[name='dataInicial']").value);
    const dataFinal = new Date(document.querySelector("input[name='dataFinal']").value);
